...
?>
                ...
                <div class="slider-content">
                    <div class="container">
                        <div class="slider-text text-center">
                            <h3 class="slide-title"><span>راه ایمن</span> و <span>آسان</span><br/> برای بدست آوردن بیت
                                کوین</h3>
                            <p>
                                <a href="about.php" class="slider btn btn-primary">اطلاعات بیشتر</a>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="item bg-parallax item-2">
                <div class="slider-content">
                    <div class="col-md-12">
                        <div class="container">
                            <div class="slider-text text-center">
                                <h3 class="slide-title"><span>راه ایمن و آسان</span> برای بدست <br/>آوردن
                                    <span>بیت کوین</span></h3>
                                <p>
                                    <a href="pricing.php" class="slider btn btn-primary">قیمت های ما</a>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row features-row">
                ...
                <div class="feature-box col-md-4 col-sm-12">
                    ...
                    <div class="feature-box-content">
                        <h3>کیف پول بیت کوین را بارگیری کنید</h3>
                        <p>برای ایجاد ، ارسال و دریافت بیت کوین آن را از طریق رایانه شخصی یا موبایل دریافت کنید.</p>
                    </div>
                </div>
                <!-- Feature Box Ends -->
                <!-- Feature Box Starts -->
                <div class="feature-box two col-md-4 col-sm-12">
                    ...
                    <div class="feature-box-content">
                        <h3>اضافه کردن سکه به کیف پول خود</h3>
                        <p>بیت کوین هایی که ایجاد کرده اید یا از طریق کارت اعتباری رد و بدل شده است.</p>
                    </div>
                </div>
                <!-- Feature Box Ends -->
                <!-- Feature Box Starts -->
                <div class="feature-box three col-md-4 col-sm-12">
                    ...
                    <div class="feature-box-content">
                        <h3>خرید / فروش با کیف پول</h3>
                        <p>آدرس گیرنده را وارد کنید ، مبلغ را مشخص کنید و ارسال کنید.</p>
                    </div>
                </div>
                <!-- Feature Box Ends -->
            </div>
        ...
        <div class="container">
            ...
            <div class="row text-center">
                ...
                <div class="title-head-subtitle">
                    <p>یک وب سایت تجاری که کیف پول ، مبادله و سایر اطلاعات مربوط به بیت کوین را لیست می کند</p>
                </div>
            </div>
            <!-- Section Title Ends -->
            ...
            <div class="row about-content">
                ...
                <div class="col-sm-12 col-md-7 col-lg-6">
                    <h3 class="title-about">ما شرکت ... هستیم</h3>
                    <p class="about-text">مکانی برای هرکسی که می خواهد بیت کوین ها را به سادگی بخرد و بفروشد. با استفاده
                        از Visa / MasterCard یا انتقال بانکی وجه خود را واریز کنید. خرید و فروش فوری بیت کوین با قیمت
                        منصفانه تضمین شده است. هیچ چیز اضافی با بیش از 700000 کاربر از سراسر جهان از خدمات ما راضی
                        شوید.</p>
                    <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#menu1">کار ما</a></li>
                        <li><a data-toggle="tab" href="#menu2">مزایای ما</a></li>
                        <li><a data-toggle="tab" href="#menu3">تضمین های ما</a></li>
                    </ul>
                    <div class="tab-content">
                        <div id="menu1" class="tab-pane fade in active">
                            <p>بیت کوین براساس پروتکل معروف به blockchain است که امکان ایجاد داده ، انتقال و تأیید صحت
                                داده های مالی بسیار مطمئن و بدون دخالت شخص ثالث را فراهم می کند..</p>
                        </div>
                        <div id="menu2" class="tab-pane fade">
                            <p>مأموریت ما به عنوان شریک رسمی بنیاد بیت کوین کمک به شما در ورود و درک بهتر جهان #
                                cryptocurrency و جلوگیری از هرگونه مشکلی است که ممکن است با آن روبرو شوید..</p>
                        </div>
                        <div id="menu3" class="tab-pane fade">
                            <p>ما در اینجا هستیم زیرا ما علاقه مند به بازارهای شفاف و باز هستیم و هدف این هستیم که یک
                                نیروی محرک اصلی در اتخاذ گسترده باشد ، ما اولین و بهترین در cryptocurrency هستیم. </p>
                        </div>
                    </div>
                    <a class="btn btn-primary" href="about.php">اطلاعات بیشتر</a>
                </div>
                <!-- Content Ends -->
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6 col-xs-12">
                            <div class="feature text-center">
                                ...
                                <h3 class="feature-title">امنیت شدید</h3>
                        ...
                        <div class="col-sm-6 col-md-6 col-xs-12">
                            <div class="feature text-center">
                                ...
                                <h3 class="feature-title">پوشش جهانی</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6 col-xs-12">
                            <div class="feature text-center">
                                ...
                                <h3 class="feature-title">گزینه های پرداخت</h3>
                        ...
                        <div class="col-sm-6 col-md-6 col-xs-12">
                            <div class="feature text-center">
                                ...
                                <h3 class="feature-title">برنامه تلفن همراه</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6 col-xs-12">
                            <div class="feature text-center">
                                ...
                                <h3 class="feature-title">راندمان هزینه</h3>
                        ...
                        <div class="col-sm-6 col-md-6 col-xs-12">
                            <div class="feature text-center">
                                ...
                                <h3 class="feature-title">نقدینگی بالا</h3>
    ...
    <section class="pricing">
        <div class="container">
            <!-- Section Title Starts -->
            <div class="row text-center">
                <h2 class="title-head">بسته های <span>مقرون به صرفه</span></h2>
                <div class="title-head-subtitle">
                ...
                <div class="pricing-container">
                    ...
                    <div class="pricing-switcher">
                        <p>
                            ...
                            <label for="buy-1">خرید</label>
                            <input type="radio" name="switch" value="sell" id="sell-1">
                            <label for="sell-1">فروش</label>
                            ...
                            <ul class="pricing-wrapper">
                                ...
                                <li data-type="buy" class="is-visible">
                                    ...
                                    <footer class="pricing-footer">
                                        <a href="#" class="btn btn-primary">اکنون سفارش دهید</a>
                                    </footer>
                                </li>
    ...
    <section class="bitcoin-calculator-section">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h2 class="title-head text-center"><span>محاسبه</span> بیت کوین</h2>
                ...
                <div class="col-md-12 text-center">
                    <form class="bitcoin-calculator" id="bitcoin-calculator">
                        ...
                        <!-- Input #1 Ends -->
                        <div class="form-info"><i class="fab fa-bitcoin"></i></div>
    ...
    <section class="team">
        <div class="container">
            <!-- Section Title Starts -->
            <div class="row text-center">
                <h2 class="title-head">کارشناسان <span>ما</span></h2>
                <div class="title-head-subtitle">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-4 img-block-quote bg-image-2">
                    <blockquote>
                        <p>بیت کوین یکی از مهمترین اختراعات در کل تاریخ بشر است. برای اولین بار ، هر کس می تواند با هر
                            کس دیگری ، هرجای کره زمین ، به راحتی و بدون محدودیت ، هر مقدار پول ارسال یا دریافت کند. این
                            طلوع یک دنیای بهتر و آزادتر است.</p>
                        <footer><img src="images/ceo.jpg" alt="ceo"/> <span>مریم معصومی</span> - مدیر عامل</footer>
                    </blockquote>
                </div>
                <!-- Quote Ends -->
                <!-- Chart Starts -->
    ...
    <section class="blog">
        <div class="container">
            <!-- Section Title Starts -->
            <div class="row text-center">
                <h2 class="title-head">اخبار <span>بیت کوین</span></h2>
                <div class="title-head-subtitle">
            ...
            <div class="row latest-posts-content">
                ...
                <div class="col-sm-4 col-md-4 col-xs-12">
                    <div class="latest-post">
                        ...
                        <a href="blog-post.php"><img class="img-responsive" src="images/blog/blog-post-small-1.jpg"
                                                     alt="img"></a>
                        <!-- Featured Image Ends -->
                        <!-- Article Content Starts -->
                        <div class="post-body">
                            <h4 class="post-title">
                                <a href="blog-post.php">چگونگی آغاز Cryptocurrency و تأثیر آن بر معاملات مالی</a>
                            </h4>
                            <div class="post-text">
                        ...
                        <a href="blog-post.php" class="btn btn-primary">اطلاعات بیشتر</a>
                ...
                <div class="col-sm-4 col-md-4 col-xs-12">
                    <div class="latest-post">
                        <!-- Featured Image Starts -->
                        <a href="blog-post.php"><img class="img-responsive" src="images/blog/blog-post-small-2.jpg"
                                                     alt="img"></a>
                        <!-- Featured Image Ends -->
                        <!-- Article Content Starts -->
                        <div class="post-body">
                            <h4 class="post-title">
                                <a href="blog-post.php">Cryptocurrency - چه کسی با آن درگیر است؟ کلمات در مورد اعضا</a>
                            </h4>
                            <div class="post-text">
                                <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان
                                    گرافیک است...</p>
                ...
                <div class="col-sm-4 col-md-4 col-xs-12">
                    <div class="latest-post">
                        <!-- Featured Image Starts -->
                        <a href="blog-post.php"><img class="img-responsive" src="images/blog/blog-post-small-3.jpg"
                                                     alt="img"></a>
                        <!-- Featured Image Ends -->
                        <!-- Article Content Starts -->
                        <div class="post-body">
                            <h4 class="post-title">
                                <a href="blog-post.php">خطرات و پاداش سرمایه گذاری در بیت کوین. مزایا و معایب</a>
                            </h4>
                            <div class="post-text">
                                <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان
                                    گرافیک است...</p>
