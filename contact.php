...
<body>
    ...
    <div id="switcher" class="">
        <div class="content-switcher">
            ...
            <p>طرح سبک</p>
            <label><input class="boxed_switch" type="radio" name="layout_style" id="is_wide" value="wide" checked="checked" /> وسیع</label>
    ...
    <div class="wrapper">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="action-text">
                                <h2>امروز با بیت کوین شروع به کار کنید</h2>
        ...
        </section>        <!-- Call To Action Section Ends -->
        <!-- Footer Starts -->
        <footer class="footer">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-5">
                            ...
                            <div class="facts-footer">
                                ...
                                <div>
                                    <h5>127</h5>
                                    <span>کشورهای پشتیبانی شده</span>
                                </div>
                            </div>
                            <!-- Facts Ends -->
                            <hr>
                            ...
                            <div class="payment-logos">
                                <h4 class="payment-title">روش های پرداخت پشتیبانی شده</h4>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <p class="text-center">کپی رایت © 2020 Bayya همه حقوق محفوظ است | راستچین شده توسط <a href="https://www.rtl-theme.com/user-profile/davod_taheri/" target="_blank">طاهری</a></p>
                            <!-- Copyright Text Ends -->
                        </div>
                    </div>
                </div>
