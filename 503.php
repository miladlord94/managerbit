        ...
        <div class="container-fluid error">
			<div>
				<div class="text-center">
					...
					<h3>خطای سرور</h3>
                    <p>سرور با خطایی روبرو شد و نتوانست درخواست شما را تکمیل کند ، لطفا بعداً دوباره امتحان کنید یا صفحه را تازه کنید </p>
					<a id="refresh" href="#" class="refresh"><i class="fa fa-refresh"></i> صفحه را تازه کنید</a>
					<!-- Error 503 Content Starts -->
				</div>
			</div>
		</div>
