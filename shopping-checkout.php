...
?>
                ...
                <div class="banner-text text-center">
                    <div class="container">
                        ...
                        <div class="row text-center">
                            <div class="col-xs-12">
                                <!-- Title Starts -->
                                <h2 class="title-head">پرداخت <span>خرید</span></h2>
                                <!-- Title Ends -->
                                <hr>
                                <!-- Breadcrumb Starts -->
                                <ul class="breadcrumb">
        ...
        <section class="shop-checkout">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <p>مشتری هستید؟ <a href="login.php">برای ورود اینجا کلیک کنید</a></p>
                        ...
                        <form class="row">
                            ...
                            <div class="col-xs-12 col-md-4">
                                <div class="form-group">
                                    <input type="text" placeholder="شرکت" class="form-control">
                                </div>
                            </div>
							<!-- Input Field Ends -->
                            <!-- Input Field Starts -->
                            ...
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <textarea placeholder="آدرس" class="form-control"></textarea>
                                </div>
                            </div>
							<!-- Input Field Ends -->
                            <!-- Input Field Starts -->
                            <div class="col-xs-12 col-md-4">
                                <div class="form-group">
                                    <input type="text" placeholder="آپارتمان ، سوئیت ، یونیت ETC. (اختیاری)" class="form-control">
                                </div>
                            </div>
							<!-- Input Field Ends -->
                            <!-- Input Field Starts -->
                            ...
                            <div class="col-xs-12 col-md-4">
                                <div class="form-group">
                                    <input type="text" placeholder="کد پستی" class="form-control">
                                </div>
                            </div>
							<!-- Input Field Ends -->
                            <!-- Input Field Starts -->
                        ...
                        <div class="col-sm-12 col-md-6">
                            <table class="table products">
                                ...
                                <tbody>
                                    <tr>
                                        <td>0.179 BTC</td>
                                        <td class="text-price">589000</td>
                                    </tr>
                                    <tr>
                                        <th class="with-bg">زیرمجموعه</th>
                                        <td class="text-price">589000</td>
                                    </tr>
									<tr>
                                        <th class="with-bg">قیمت بدون مالیات</th>
                                        <td class="text-price">589000</td>
                                    </tr>
                                    <tr>
                                        <th class="with-bg">جمع</th>
                                        <td class="text-price big-price">607000</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-6 text-right">
                            <form class="payment text-left">
                                ...
                                <div class="cheque">
                                    <div class="radio">
                                        <label>
											...
											<span>پرداخت را بررسی کنید</span>
										</label>
                                    </div>
                                    <p class="text-dark">لطفاً چک خود را از طریق پست به ما ارسال کنید : <strong>ایران , تهران , نیاوران , خیابان بهشت , پلاک 12345</strong></p>
                                </div>
								<!-- Payment Cheque Ends -->
                                ...
                                <div class="paypal">
									...
									<span class="tooltip-text" data-toggle="tooltip" data-placement="top" title="PayPal is a service that enables you to pay, send money, and accept payments. Register your credit card or debit card with your PayPal account. You can pay by simply choosing PayPal at checkout">پی پال چیست؟</span>
									<!-- Paypal Tooltip Ends -->
								...
								<!-- Payment Paypal Ends -->
                                <button type="submit" class="btn btn-primary btn-order pull-left">ترتیب سفارش</button>
                            </form>
                        </div>
